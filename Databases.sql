...
CREATE VIEW ROUTES_THROUGH_LONDON AS
SELECT DISTINCT ROUTE.ROUTE_NUM
FROM STOPS
JOIN ROUTE ON STOPS.ROUTE_NUM=ROUTE.ROUTE_NUM
WHERE STOPS.STAT_NUM=104 OR ROUTE.ORIGIN=104 OR ROUTE.DESTINATION=104;
