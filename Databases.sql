...
CREATE TABLE ROUTE(
	...
	ORIGIN		NUMERIC(3,0) NOT NULL,
	DESTINATION	NUMERIC(3,0) NOT NULL,
...
CREATE TABLE TICKET(
 	ICKET_ID     NUMERIC(7,0) NOT NULL,
	INV_ID 	NUMERIC(7,0) NOT NULL,
	R_ASSGN	NUMERIC(7,0) NOT NULL,
	SEAT_NUM      VARCHAR(6)
...
CREATE TABLE TRAIN_ASSGN(
	...
	TRAIN_NUM	NUMERIC(4,0) NOT NULL,
	START_DATE	DATE NOT NULL
	END_DATE	DATE 
	PRIMARY KEY(T_ASSGN),
	FOREIGN KEY(EMP_ID) REFERENCES EMPLOYEE(EMP_ID)
